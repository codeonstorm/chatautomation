  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      if (message.toLowerCase().includes("order") && message.toLowerCase().includes("status")) {
        botResponse = {
          role: "bot",
          content: "Your order AB1234 is currently being processed and will be shipped within 2 business days.",
          intent: "Order Status",
          confidence: 0.92,
          ...
          webhook: {
            name: "Order API",
            status: "Success",
            response: '{"status": "processing", "estimated_shipping": "2 business days"}',
          },
        }
      ...
      } else if (message.toLowerCase().includes("product") || message.toLowerCase().includes("laptop")) {
        botResponse = {
          role: "bot",
          content:
          ...
          webhook: {
            ...
            status: "Success",
            response: '{"product": "XPS 15", "specs": {"ram": "16GB", "storage": "512GB SSD"}}',
          },
        }
      }
  ...
  return (
    <div className="space-y-6 py-6">
      <div>
        ...
        <p className="text-muted-foreground">Test your conversational AI in real-time.</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card className="md:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Test your bot by sending messages and see how it responds.</CardDescription>
          </CardHeader>
                  ...
                  >
                    ...
                    {msg.intent && (
                      <div className="mt-2 space-y-1 border-t pt-2 text-xs">
                        ...
                        <Progress value={msg.confidence! * 100} className="h-1" />
                      </div>
                    )}
                      ...
                      <div className="mt-2 border-t pt-2 text-xs">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {msg.entities.map((entity, i) => (
                            <div key={i} className="rounded-full bg-primary/10 px-2 py-0.5">
                    ...
                    {msg.webhook && (
                      <div className="mt-2 border-t pt-2 text-xs">
                        <div className="mb-1">Webhook: {msg.webhook.name}</div>
                        <div
                        ...
                        {msg.webhook.response && (
                          <div className="mt-1 flex items-center justify-between rounded bg-black/10 p-1 font-mono dark:bg-white/10">
                            <div className="truncate">{msg.webhook.response}</div>
                            <Button
                              variant="ghost"
                              size="sm"
                              className="h-5 w-5 p-0"
                              onClick={() => copyToClipboard(msg.webhook!.response!)}
                            >
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Tools to help you test your bot.</CardDescription>
          </CardHeader>
            ...
            <Tabs defaultValue="suggestions">
              ...
              <TabsContent value="suggestions" className="space-y-4 pt-4">
                <div className="space-y-2">
                  <h3 className="text-sm font-medium">Try these phrases</h3>
                  <div className="space-y-2">
                    <Button
                      variant="outline"
                      size="sm"
                      ...
                      onClick={() => {
                        setMessage("What's the status of my order AB1234?")
